...
DIMENSION_SCREW_HOLES_OFFSET = 0.6  # Default: 0.8, reduced for 6 mm magnet: 0.7, reduced for 3 mm magnet: 0.6
...
DIMENSION_MAGNET_CUTOUT_RIM = 0.01
DIMENSION_MAGNET_CUTOUT_RIM_DEPTH = 0.05
